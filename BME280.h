 ...
 * Author: Drew
 *
 * Created on April 15, 2017, 11:29 AM
 */
#define BME280_ADDRESS (0x77)
#define _i2caddr  0x77
...
long int BME280_compensate_T_int32(long int adc_T);
uint32_t BME280_compensate_P_int32(uint32_t adc_P);
